...
class Ui_MainW(object):
    def setupUi(self, MainW):
        ...
        self.vChannelSelect.setGeometry(QtCore.QRect(40, 205, 51, 111))
        self.vChannelSelect.setObjectName("vChannelSelect")
        self.vParamSelect = QtWidgets.QListWidget(MainW)
        self.vParamSelect.setGeometry(QtCore.QRect(120, 205, 141, 111))
        ...
        self.hLabel.setGeometry(QtCore.QRect(9, 90, 21, 111))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.vLabel.setGeometry(QtCore.QRect(9, 210, 21, 101))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.workingClusterLabel.setGeometry(QtCore.QRect(40, 320, 61, 41))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.viewButton.setGeometry(QtCore.QRect(180, 610, 51, 31))
        self.viewButton.setStyleSheet("font: 9pt \"Noto Sans\";")
        self.viewButton.setObjectName("viewButton")
        self.quitButton = QtWidgets.QPushButton(MainW)
        self.quitButton.setGeometry(QtCore.QRect(0, 800, 63, 31))
        self.quitButton.setObjectName("quitButton")
        self.addButton = QtWidgets.QPushButton(MainW)
        self.addButton.setGeometry(QtCore.QRect(20, 580, 51, 31))
        font = QtGui.QFont()
        ...
        self.refineButton.setGeometry(QtCore.QRect(170, 580, 51, 31))
        ...
        self.reportClusterButton.setGeometry(QtCore.QRect(80, 610, 51, 31))
        ...
        self.nextWavesButton.setGeometry(QtCore.QRect(60, 550, 51, 31))
        ...
        self.stepBackBoundButton.setGeometry(QtCore.QRect(30, 610, 51, 31))
        ...
        self.prevWavesButton.setGeometry(QtCore.QRect(10, 550, 51, 31))
        ...
        self.resetWaveNButton.setGeometry(QtCore.QRect(160, 550, 51, 31))
        ...
        self.timeResetButton.setGeometry(QtCore.QRect(200, 650, 51, 31))
        self.timeResetButton.setObjectName("timeResetButton")
        self.clustRateBox = QtWidgets.QSpinBox(MainW)
        self.clustRateBox.setGeometry(QtCore.QRect(210, 410, 51, 31))
        ...
        self.undoClustButton.setGeometry(QtCore.QRect(220, 580, 51, 31))
        ...
        self.toggleRefWaveChsButton.setGeometry(QtCore.QRect(210, 550, 51, 31))
        ...
        self.elimOutlierButton.setGeometry(QtCore.QRect(182, 740, 81, 31))
        ...
        self.finalizeElimOutlierBox.setGeometry(QtCore.QRect(182, 780, 81, 31))
